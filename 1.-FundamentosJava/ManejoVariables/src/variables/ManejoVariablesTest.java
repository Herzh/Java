...
System.out.println("");
//Variable char, declaracione inicializacionen una sola linea
...
int hexa= 0x64;//Valor hexadecimal oniciacon 0x
System.out.println("Valor intdecimal:"+ decimal);
System.out.println("Valor intoctal:"+ octal);
